...
NAN_METHOD(SetFont) {
    if(info.Length()==1){
        ...
        switch(fontName){
			case 0: ssd1306SetFont((FONT_INFO*)&ubuntuMono_8ptFontInfo); break;
			case 1: ssd1306SetFont((FONT_INFO*)&ubuntuMono_16ptFontInfo); break;
			case 2: ssd1306SetFont((FONT_INFO*)&ubuntuMono_24ptFontInfo); break;
			case 3: ssd1306SetFont((FONT_INFO*)&ubuntuMono_48ptFontInfo); break;
		}
    }
    else
        return Nan::ThrowTypeError("Wrong argument number!");
